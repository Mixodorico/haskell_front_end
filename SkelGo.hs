...
transBLexp x = case x of
  ...
  ExpId cident rexp -> failure x
transProgram :: Program -> Result
transProgram x = case x of
  Prog cident statements -> failure x
...
transStatement x = case x of
  ...
  StateIfStm decl rexp block -> failure x
  StateIfElseStm decl rexp block1 block2 -> failure x
  StateFor decl1 rexp decl2 block -> failure x
