...
RExp13 :: { RExp }
RExp13 : '(' RExp ')' { $2 } | LExp { AbsGo.LExprex $1 }
LExp :: { LExp }
LExp : LExp1 { $1 } | '*' RExp { AbsGo.Deref $2 }
LExp1 :: { LExp }
LExp1 : LExp2 { $1 }
      | LExp2 '++' { AbsGo.PostInc $1 }
      | LExp2 '--' { AbsGo.PostDecr $1 }
LExp2 :: { LExp }
LExp2 : '(' LExp ')' { $2 } | BLexp { AbsGo.BLExprex $1 }
RExp14 :: { RExp }
RExp14 : '(' RExp ')' { AbsGo.Par $2 }
FunCall :: { FunCall }
FunCall : CIdent '(' ')' { AbsGo.ExpFuncEmpty $1 }
        | CIdent '(' ListRExp ')' { AbsGo.ExpFunc $1 $3 }
BLexp :: { BLexp }
BLexp : BLexp '[' RExp ']' { AbsGo.ExpArr $1 $3 }
      | CIdent { AbsGo.ExpId $1 }
Program :: { Program }
Program : 'package' CIdent ListDecl { AbsGo.Prog $2 (reverse $3) }
ListDecl :: { [Decl] }
...
Decl : 'var' ListCIdent BasicType { AbsGo.DeclVar $2 $3 }
     ...
     | 'func' CIdent '(' ListParam ')' BasicType Block { AbsGo.DeclFun $2 $4 $6 $7 }
     | 'func' CIdent '(' ListParam ')' Block { AbsGo.DeclProc $2 $4 $6 }
ShortVarDecl :: { ShortVarDecl }
ShortVarDecl : ListCIdent ':=' ListRExp { AbsGo.DeclVarShort $1 $3 }
