...
instance Print Program where
  prt i e = case e of
    Initprogram id decls -> prPrec i 0 (concatD [doc (showString "package"), prt 0 id, prt 0 decls])
...
instance Print RExp where
  prt i e = case e of
    ...
    LExpes rexp1 rexp2 -> prPrec i 0 (concatD [prt 0 rexp1, doc (showString "<"), prt 0 rexp2])
    LExpeq rexp1 rexp2 -> prPrec i 0 (concatD [prt 0 rexp1, doc (showString "<="), prt 0 rexp2])
    ...
    LExpef lexp -> prPrec i 0 (concatD [prt 0 lexp])
    ...
    RExpef lexp -> prPrec i 0 (concatD [doc (showString "&"), prt 0 lexp])
