...
instance Print RExp where
  prt i e = case e of
    ...
    Par rexp -> prPrec i 14 (concatD [doc (showString "("), prt 0 rexp, doc (showString ")")])
  prtList _ [x] = (concatD [prt 0 x])
  prtList _ (x:xs) = (concatD [prt 0 x, doc (showString ","), prt 0 xs])
instance Print LExp where
  prt i e = case e of
    Deref rexp -> prPrec i 0 (concatD [doc (showString "*"), prt 0 rexp])
    PostInc lexp -> prPrec i 1 (concatD [prt 2 lexp, doc (showString "++")])
    PostDecr lexp -> prPrec i 1 (concatD [prt 2 lexp, doc (showString "--")])
    BLExprex blexp -> prPrec i 2 (concatD [prt 0 blexp])
...
instance Print BLexp where
  prt i e = case e of
    ...
    ExpId cident -> prPrec i 0 (concatD [prt 0 cident])

instance Print Program where
  prt i e = case e of
    Prog cident decls -> prPrec i 0 (concatD [doc (showString "package"), prt 0 cident, prt 0 decls])
...
instance Print Decl where
  prt i e = case e of
    ...
    DeclFun cident params basictype block -> prPrec i 0 (concatD [doc (showString "func"), prt 0 cident, doc (showString "("), prt 0 params, doc (showString ")"), prt 0 basictype, prt 0 block])
    DeclProc cident params block -> prPrec i 0 (concatD [doc (showString "func"), prt 0 cident, doc (showString "("), prt 0 params, doc (showString ")"), prt 0 block])
  prtList _ [] = (concatD [])
